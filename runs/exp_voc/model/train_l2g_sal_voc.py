...
def get_arguments():
    ...
    parser.add_argument("--img_dir", type=str, default='D:\\Pycharm\\PyCharmProjects\\L2G-main_ori\\data\\voc12')
    parser.add_argument("--train_list", type=str, default='D:\\Pycharm\\PyCharmProjects\\L2G-main_ori\\data\\voc12\\train_cls.txt')
    parser.add_argument("--test_list", type=str, default='D:\\Pycharm\\PyCharmProjects\\L2G-main_ori\\data\\voc12\\val_cls.txt')
...
def get_resnet38_model(args):
    ...
    if len(args.load_checkpoint) == 0:
        weights_dict = models.resnet38_base.convert_mxnet_to_torch('D:\\Pycharm\\PyCharmProjects\\L2G-main_ori\\models\\ilsvrc-cls_rna-a1_cls1000_ep-0001.params')
